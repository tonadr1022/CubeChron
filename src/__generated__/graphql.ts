...
export type UpdateCubeSessionMutation = { __typename?: 'Mutation', updateCubeSession: { __typename?: 'CubeSession', id: string, name: string, cubeType: string, notes?: string | null } };
